		...
		<view class="list-card" v-if="mode === 'base'">
			...
			<view class="list-card-content">
				<view class="list-card-title">
					<text>uniapp开发框架uniapp开发框架uniapp开发框架uniapp开发框架uniapp开发框架uniapp开发框架uniapp开发框架uniapp开发框架</text>
				</view>
				<view class="list-card-des">
					<view class="list-card-tag">
						<view class="left">前端开发</view>
						<view class="right">293浏览</view>
					</view>
				</view>
			</view>
		</view>
		...
		<view v-if="mode === 'column'" class="list-card mode-column">
			<view class="list-card-content">
				<view class="list-card-title">
					...
					<view class="list-card-img">
						<view class="" v-for="item in 3" :key='index' class="list-card-img-item">
							<image src="../../static/logo.png" mode="aspectFit"></image>				
						</view>
					</view>
